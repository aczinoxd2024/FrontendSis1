...
export const routes: Routes = [
  {
    path: '',
    loadComponent: () =>
      import('./Paginas/welcome/welcome.component').then((m) => m.WelcomeComponent),
  },
  {
    path: 'login',
    loadComponent: () =>
      import('./Paginas/login-page/login-page.component').then((m) => m.LoginComponent),
  },
 ...
 // 🧾 ADMINISTRADOR
{
  ...
  // 🧾 RECEPCIONISTA (corregido aquí)
  {
    ...
    loadComponent: () =>
      import('./Paginas/dashboard/dashboard-recepcionista/dashboard-recepcionista.component').then((m) => m.DashboardRecepcionistaComponent),
    canActivate: [recepcionistaGuard],
    children: [
      {
        path: 'registrar-cliente',
        loadComponent: () =>
          import('./Paginas/dashboard/dashboard-recepcionista/registrar-cliente/registrar-cliente.component').then((m) => m.RegistrarClienteComponent),
      },
      {
        path: 'actualizar-cliente',
        loadComponent: () =>
          import('./Paginas/dashboard/dashboard-recepcionista/actualizar-cliente/actualizar-cliente.component').then((m) => m.ActualizarClienteComponent),
      },
      {
        path: 'clientes',
        loadComponent: () =>
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./Paginas/dashboard/dashboard-recepcionista/asistencias-hoy/asistencias-hoy.component').then((m) => m.AsistenciasHoyComponent),
      },
      {
        path: 'comprobantes',
        loadComponent: () =>
...
},
{
  ...
  // 🧾 INSTRUCTOR
  {
    ...
    loadComponent: () =>
      import('./Paginas/dashboard/dashboard-instructor/dashboard-instructor.component').then((m) => m.DashboardInstructorComponent),
  ...
  // 📌 MEMBRESÍAS
  {
    path: 'menbresias',
    loadComponent: () =>
      import('./Paginas/ver-menbresias/menbresias.component').then((m) => m.MenbresiasComponent),
  },
  {
    path: 'adquirir-menbresia/:id',
    loadComponent: () =>
      import('./Paginas/adquirir-membresia/adquirir-membresia.component').then((m) => m.AdquirirMembresiaComponent),
  },
  {
    path: 'renovar-membresia',
    loadComponent: () =>
      import('./Paginas/adquirir-membresia/renovar-membresia/renovar-membresia.component').then((m) => m.RenovarMembresiaComponent),
  },
  ...
  },
  {
    path: 'perfil/editar',
    loadComponent: () =>
      import('./Paginas/perfil/editar-perfil/editar-perfil.component').then((m) => m.EditarPerfilComponent),
  },
  ...
  // 📌 RECUPERACIÓN DE CONTRASEÑA
  {
    ...
    loadComponent: () =>
      import('./Paginas/forgot-password/forgot-password.component').then((m) => m.ForgotPasswordComponent),
  },
  {
    path: 'reset-password',
    loadComponent: () =>
      import('./Paginas/reset-password/reset-password.component').then((m) => m.ResetPasswordComponent),
  },
  ...
  // 📌 PAGOS
  {
    path: 'pagos/success',
    loadComponent: () =>
      import('./pagos/pago-exitoso.component').then((m) => m.PagoExitosoComponent),
  },
  {
    path: 'pagos/cancel',
    loadComponent: () =>
      import('./pagos/pago-cancelado.component').then((m) => m.PagoCanceladoComponent),
  },
